    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starting', models.DecimalField(decimal_places=2, max_digits=10)),
                ('image_url', models.URLField(blank=True, max_length=1000)),
                ('category', models.CharField(blank=True, choices=[('Electronics', 'Electronics'), ('Toys', 'Toys'), ('Home', 'Home'), ('Fashion', 'Fashion')], max_length=50)),
